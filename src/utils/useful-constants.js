...
export const LCA_INDICATORS = [
	{
		...
		processes: [
			...
			"Urea production",
			"Remaining processes",
			"Diesel burned in machinery",
		],
		substances: ["Remaining substances", "Carbon dioxide, fossil", "Dinitrogen monoxide"],
	},
	{
		label: "Terrestrial acidification",
		options: [],
		processes: [],
		substances: ["Remaining substances", "Ammonia"],
	},
	{
		label: "Marine eutrophication",
		options: ["Marine eutrophication"],
		processes: [],
		substances: ["Remaining substances", "Nitrate"],
	},
	{
		...
		processes: [
			...
			"Tractor production",
			"Korn-kali production",
			"Direct emissions",
		],
		substances: ["Remaining substances", "Copper, ion", "Flufenacet", "Folpet"],
	},
	{
		label: "Land use",
		options: ["Mineral resource scarcity", "Fossil resource scarcity"],
		processes: [],
		substances: ["Occupation, annual crop"],
	},
	{
		label: "Water consumption",
		options: [],
		processes: [],
		substances: ["water, unspecified origin"],
	},
];
